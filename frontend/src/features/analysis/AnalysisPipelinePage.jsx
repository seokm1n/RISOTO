...
export default function AnalysisPipelinePage() {
  ...
  }, [collectionDate, filterDecision, page, period, periodQuery, riskClassification, selectedCompanyId, stageId, viewKey]);
