...
const STAGES = [
  ...
  { id: "response", step: "06", label: "대응전략", kicker: "RESPONSE MANAGEMENT", description: "위험 사건의 대응방안을 생성하고 검토·승인 이력을 관리합니다." },
];
